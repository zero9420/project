				...
				<div class="member-caution clearfix">
					<ul>
						...
						<li class="clearfix">
							...
							<input type="text" class="war" name="info_nickname">
						</li>
						<li class="clearfix">
							<div class="warn6"></div>
							<div class="warn2">手机号</div>
							<input type="text" class="war" name="info_telphone">
						</li>
						<li class="clearfix">
							<div class="warn6"></div>
							<div class="warn2">收货地址</div>
							<input type="text" class="wa" name="info_address">
						</li>
						<li class="clearfix">
							<div class="warn6"></div>
