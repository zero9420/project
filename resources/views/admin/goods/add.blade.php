            ...
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="medium" name="goods_name" id="goodsname" maxlength="30" placeholder="请输入最多30字符的商品名">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="number" class="medium" name="goods_stock" value="{{old('goods_stock')}}" class="error large">
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="number" class="medium" name="goods_preferential" class="error large" placeholder="请输入优惠价格,不得大于原价,默认等于原价">
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="file" name='goods_pic[]' multiple="multiple" placeholder="No file selected...">
                    </div>
                </div>
                <script>
                    //实例化编辑器
