...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
            ...
            <form action="/admin/express" method='get'>
                ...
                <div class="dataTables_filter" id="DataTables_Table_1_filter">
                    <label>
                        关键字:
                        <input type="text" name='express_title' value="{{$arr['search']}}" aria-controls="DataTables_Table_1">
                    </label>
                   ...
                   @foreach($res as $k =>$v)
                    ...
                    <tr class="">
                        ...
                        <td class=" ">
                         ...
                         <td class=" ">
                            <a href="/admin/express/{{$v->express_id}}/edit" class="btn btn-info">修改</a>
                            <form action="/admin/express/{{$v->express_id}}" method='post' style='display:inline'>
